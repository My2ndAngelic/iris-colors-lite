...
/* ./.libs/lt-redshift.c - temporary wrapper executable for .libs/redshift.exe
...
const char * TARGET_PROGRAM_NAME = "redshift.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# redshift - temporary wrapper script for .libs/redshift.exe\n", f);
  ...
  fputs ("    echo \"redshift.exe:redshift:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"redshift.exe:redshift:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"redshift.exe:redshift:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
