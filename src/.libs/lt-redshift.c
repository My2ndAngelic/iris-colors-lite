...
/* ./.libs/lt-redshift.c - temporary wrapper executable for .libs/redshift
   Generated by libtool (GNU libtool) 2.4.6

   The redshift program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "redshift"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# redshift - temporary wrapper script for .libs/redshift\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The redshift program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /usr/lib/libintl.la /usr/lib/libiconv.la /usr/lib/libiconv.", f);
  fputs ("la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"redshift:redshift:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"redshift:redshift:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"redshift:redshift:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
